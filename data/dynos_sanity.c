...
bool dynos_sanity_check_geo(s16 graphNodeType) {
    return (graphNodeType == GRAPH_NODE_TYPE_ROOT)
           ...
           || (graphNodeType == GRAPH_NODE_TYPE_MASTER_LIST) || (graphNodeType == GRAPH_NODE_TYPE_START)
           ...
           || (graphNodeType == GRAPH_NODE_TYPE_ROTATION) || (graphNodeType == GRAPH_NODE_TYPE_OBJECT)
           ...
           || (graphNodeType == GRAPH_NODE_TYPE_SCALE) || (graphNodeType == GRAPH_NODE_TYPE_SHADOW)
