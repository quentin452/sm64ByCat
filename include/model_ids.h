...
/* Various static level geometry, the geo layout differs but terrain object presets treat them the
 * same.*/
...
#define MODEL_VCUTM_CHECKERBOARD_PLATFORM_SPAWNER                                                      \
    0x37 //! @bug this object doesn't have a geo associated with it, yet is placed in vcutm.
...
// group 12
#define MODEL_BOWSER                                                                                   \
    0x64 // bowser_geo - 2nd geo loaded is bowser_geo_000424, starts with shadow command
#define MODEL_BOWSER_BOMB_CHILD_OBJ                                                                    \
    0x65 // bowser_bomb_geo - Spawns as a chill object in bowser's behavior command, causing an
         // explosion if it touches a bomb
...
#define MODEL_BOWSER2                                                                                  \
    0x69 // bowser2_geo - 2nd geo loaded is bowser_geo_000770, starts with node command, only difference
...
#define MODEL_UNKNOWN_AC                                                                               \
    0xAC // according to an special preset, it was the original id of the castle floor trap
...
#define MODEL_TRAJECTORY_MARKER_BALL                                                                   \
    0xE1 // bowling_ball_track_geo - duplicate used in SSL Pyramid small sized and as a track ball
