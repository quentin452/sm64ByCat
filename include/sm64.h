...
#define ACT_IDLE                                                                                       \
    0x0C400201 // (0x001 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_START_SLEEPING                                                                             \
    0x0C400202 // (0x002 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_SLEEPING                                                                                   \
...
#define ACT_PANTING                                                                                    \
    0x0C400205 // (0x005 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
...
#define ACT_STANDING_AGAINST_WALL                                                                      \
    0x0C400209 // (0x009 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_COUGHING                                                                                   \
    0x0C40020A // (0x00A | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_SHIVERING                                                                                  \
    0x0C40020B // (0x00B | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_IN_QUICKSAND 0x0002020D // (0x00D | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE)
#define ACT_CROUCHING                                                                                  \
    0x0C008220 // (0x020 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_START_CROUCHING                                                                            \
    0x0C008221 // (0x021 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_STOP_CROUCHING                                                                             \
    0x0C008222 // (0x022 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_START_CRAWLING                                                                             \
    0x0C008223 // (0x023 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
#define ACT_STOP_CRAWLING                                                                              \
    0x0C008224 // (0x024 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON |
               // ACT_FLAG_PAUSE_EXIT)
...
#define ACT_TWIRL_LAND                                                                                 \
    0x18800238 // (0x038 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_PAUSE_EXIT |
...
#define ACT_RIDING_SHELL_GROUND                                                                        \
    0x20810446 // (0x046 | ACT_FLAG_MOVING | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING |
...
#define ACT_STOMACH_SLIDE                                                                              \
    0x008C0453 // (0x053 | ACT_FLAG_MOVING | ACT_FLAG_BUTT_OR_STOMACH_SLIDE | ACT_FLAG_DIVING |
               // ACT_FLAG_ATTACKING)
...
#define ACT_HOLD_STOMACH_SLIDE                                                                         \
    0x008C0455 // (0x055 | ACT_FLAG_MOVING | ACT_FLAG_BUTT_OR_STOMACH_SLIDE | ACT_FLAG_DIVING |
               // ACT_FLAG_ATTACKING)
...
#define ACT_CROUCH_SLIDE                                                                               \
    0x04808459 // (0x059 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ATTACKING |
...
#define ACT_RIDING_SHELL_JUMP                                                                          \
    0x0281089A // (0x09A | ACT_FLAG_AIR | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING |
               // ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_WATER_IDLE                                                                                 \
    0x380022C0 // (0x0C0 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_WATER_IDLE                                                                            \
    0x380022C1 // (0x0C1 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_ACTION_END                                                                           \
    0x300022C2 // (0x0C2 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_WATER_ACTION_END                                                                      \
    0x300022C3 // (0x0C3 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_DROWNING                                                                                   \
    0x300032C4 // (0x0C4 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_SWIMMING |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_BACKWARD_WATER_KB                                                                          \
    0x300222C5 // (0x0C5 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_INVULNERABLE |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_FORWARD_WATER_KB                                                                           \
    0x300222C6 // (0x0C6 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_INVULNERABLE |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_DEATH                                                                                \
    0x300032C7 // (0x0C7 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_SWIMMING |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_SHOCKED                                                                              \
    0x300222C8 // (0x0C8 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_INVULNERABLE |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_BREASTSTROKE                                                                               \
    0x300024D0 // (0x0D0 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_SWIMMING_END                                                                               \
    0x300024D1 // (0x0D1 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_FLUTTER_KICK                                                                               \
    0x300024D2 // (0x0D2 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_BREASTSTROKE                                                                          \
    0x300024D3 // (0x0D3 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_SWIMMING_END                                                                          \
    0x300024D4 // (0x0D4 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_FLUTTER_KICK                                                                          \
    0x300024D5 // (0x0D5 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_SHELL_SWIMMING                                                                       \
    0x300024D6 // (0x0D6 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_THROW                                                                                \
    0x300024E0 // (0x0E0 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_PUNCH                                                                                \
    0x300024E1 // (0x0E1 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_PLUNGE                                                                               \
    0x300022E2 // (0x0E2 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING |
               // ACT_FLAG_WATER_OR_TEXT)
#define ACT_CAUGHT_IN_WHIRLPOOL                                                                        \
    0x300222E3 // (0x0E3 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_INVULNERABLE |
               // ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
...
#define VALID_BUTTONS                                                                                  \
    (A_BUTTON | B_BUTTON | Z_TRIG | START_BUTTON | U_JPAD | D_JPAD | L_JPAD | R_JPAD | L_TRIG | R_TRIG \
