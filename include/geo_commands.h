...
#define GEO_NODE_SCREEN_AREA(numEntries, x, y, width, height)                                          \
    CMD_BBH(0x08, 0x00, numEntries), CMD_HH(x, y), CMD_HH(width, height)
...
#define GEO_CAMERA_FRUSTUM_WITH_FUNC(fov, near, far, func)                                             \
    CMD_BBH(0x0A, 0x01, fov), CMD_HH(near, far), CMD_PTR(func)
...
#define GEO_RENDER_RANGE(minDistance, maxDistance)                                                     \
    CMD_BBH(0x0D, 0x00, 0x0000), CMD_HH(minDistance, maxDistance)
...
#define GEO_CAMERA(type, x1, y1, z1, x2, y2, z2, function)                                             \
    CMD_BBH(0x0F, 0x00, type), CMD_HHHHHH(x1, y1, z1, x2, y2, z2), CMD_PTR(function)
...
#define GEO_TRANSLATE_ROTATE_WITH_DL(layer, tx, ty, tz, rx, ry, rz, displayList)                       \
    CMD_BBH(0x10, (0x00 | layer | 0x80), 0x0000), CMD_HHHHHH(tx, ty, tz, rx, ry, rz),                  \
        CMD_PTR(displayList)
...
#define GEO_TRANSLATE_WITH_DL(layer, tx, ty, tz, displayList)                                          \
    CMD_BBH(0x10, (0x10 | layer | 0x80), tx), CMD_HH(ty, tz), CMD_PTR(displayList)
...
#define GEO_ROTATE_WITH_DL(layer, rx, ry, rz, displayList)                                             \
    CMD_BBH(0x10, (0x20 | layer | 0x80), rx), CMD_HH(ry, rz), CMD_PTR(displayList)
...
#define GEO_ROTATE_Y_WITH_DL(layer, ry, displayList)                                                   \
    CMD_BBH(0x10, (0x30 | layer | 0x80), ry), CMD_PTR(displayList)
...
#define GEO_TRANSLATE_NODE_WITH_DL(layer, ux, uy, uz, displayList)                                     \
    CMD_BBH(0x11, (layer | 0x80), ux), CMD_HH(uy, uz), CMD_PTR(displayList)
...
#define GEO_ROTATION_NODE_WITH_DL(layer, ux, uy, uz, displayList)                                      \
    CMD_BBH(0x12, (layer | 0x80), ux), CMD_HH(uy, uz), CMD_PTR(displayList)
...
#define GEO_ANIMATED_PART(layer, x, y, z, displayList)                                                 \
    CMD_BBH(0x13, layer, x), CMD_HH(y, z), CMD_PTR(displayList)
...
#define GEO_BILLBOARD_WITH_PARAMS_AND_DL(layer, tx, ty, tz, displayList)                               \
    CMD_BBH(0x14, (layer | 0x80), tx), CMD_HH(ty, tz), CMD_PTR(displayList)
...
#define GEO_HELD_OBJECT(param, ux, uy, uz, nodeFunc)                                                   \
    CMD_BBH(0x1C, param, ux), CMD_HH(uy, uz), CMD_PTR(nodeFunc)
...
#define GEO_SCALE_WITH_DL(layer, scale, displayList)                                                   \
    CMD_BBH(0x1D, (layer | 0x80), 0x0000), CMD_W(scale), CMD_PTR(displayList)
 ...
 */
#define GEO_NOP_1F()                                                                                   \
    CMD_BBH(0x1F, 0x00, 0x0000), CMD_HH(0x0000, 0x0000), CMD_HH(0x0000, 0x0000), CMD_HH(0x0000, 0x0000)
