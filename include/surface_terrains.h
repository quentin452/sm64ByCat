...
#define SURFACE_MGR_MUSIC                                                                              \
    0x001A // Plays the Merry go round music, see handle_merry_go_round_music in
           // bbh_merry_go_round.inc.c for more details
#define SURFACE_INSTANT_WARP_1B                                                                        \
    0x001B // Instant warp to another area, used to warp between areas in WDW and the endless stairs to
           // warp back
#define SURFACE_INSTANT_WARP_1C                                                                        \
    0x001C // Instant warp to another area, used to warp between areas in WDW
#define SURFACE_INSTANT_WARP_1D                                                                        \
    0x001D // Instant warp to another area, used to warp between areas in DDD, SSL and TTM
#define SURFACE_INSTANT_WARP_1E                                                                        \
