...
#define SPTYPE_DEF_PARAM_AND_YROT                                                                      \
    4 // object is 10-bytes long, has y-rotation and uses the default param
...
static struct SpecialPreset SpecialObjectPresets[] = {
    ...
    { 0x06, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_LLL_MOVING_OCTAGONAL_MESH_PLATFORM,
    ...
    { 0x0A, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_LLL_ROTATING_BLOCK_FIRE_BARS,
    ...
    { 0x0D, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_LLL_ROTATING_HEXAGONAL_RING,
      bhvLllRotatingHexagonalRing },
    { 0x0E, SPTYPE_YROT_NO_PARAMS, 0x00, MODEL_LLL_SINKING_RECTANGULAR_PLATFORM,
      bhvLllSinkingRectangularPlatform },
    { 0x0F, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_LLL_SINKING_SQUARE_PLATFORMS,
      bhvLllSinkingSquarePlatforms },
    { 0x10, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_LLL_TILTING_SQUARE_PLATFORM,
    ...
    { 0x22, SPTYPE_NO_YROT_OR_PARAMS, 0x00, MODEL_WF_ROTATING_WOODEN_PLATFORM,
