...
// Fourth Byte (Lower Nibble): Sound Status (this is set to SOUND_STATUS_PLAYING when passed to the
// audio driver.)
#define SOUND_ARG_LOAD(bank, playFlags, soundID, priority, flags2)                                     \
    (((u32)(bank) << 28) | ((u32)(playFlags) << 24) | ((u32)(soundID) << 16) | ((u32)(priority) << 8)  \
