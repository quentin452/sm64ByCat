...
const Trajectory ccm_seg7_trajectory_0701669C[] = {
    TRAJECTORY_POS(0, /*pos*/ 571, -4450, 6426),   TRAJECTORY_POS(1, /*pos*/ -198, -4120, 6426),
    TRAJECTORY_POS(2, /*pos*/ -1222, -3569, 6426), TRAJECTORY_POS(3, /*pos*/ -2246, -2814, 6426),
    TRAJECTORY_POS(4, /*pos*/ -3050, -2139, 6426), TRAJECTORY_POS(5, /*pos*/ -2246, -2814, 6426),
    TRAJECTORY_POS(6, /*pos*/ -1222, -3569, 6426), TRAJECTORY_POS(7, /*pos*/ -198, -4120, 6426),
    TRAJECTORY_POS(8, /*pos*/ 571, -4450, 6426),   TRAJECTORY_END(),
};
